...
%%%% SCIENTIFIC PAPERS
\newcommand{\coveredCategories}{seven\xspace}
\newcommand{\CoveredCategories}{Seven\xspace}
\newcommand{\numCoveredCategories}{7\xspace}

\newcommand{\monitoringPapers}{seven\xspace}
\newcommand{\MonitoringPapers}{Seven\xspace}
\newcommand{\numMonitoringPapers}{7\xspace}

\newcommand{\tePapers}{nineteen\xspace}
\newcommand{\TePapers}{Nineteen\xspace}
\newcommand{\numTePapers}{19\xspace}

\newcommand{\failurePapers}{nine\xspace}
\newcommand{\FailurePapers}{Nine\xspace}
\newcommand{\numFailurePapers}{9\xspace}

\newcommand{\ccaPapers}{fourteen\xspace}
\newcommand{\CcaPapers}{Fourteen\xspace}
\newcommand{\numCcaPapers}{14\xspace}
...
\newcommand{\miscPapers}{six\xspace}
\newcommand{\MiscPapers}{Six\xspace}
\newcommand{\numMiscPapers}{6\xspace}

\newcommand{\totalPapers}{seventy five\xspace}
\newcommand{\TotalPapers}{Seventy Five\xspace}
\newcommand{\numTotalPapers}{75\xspace}

%%%% STANDARDIZATION DRAFTS

% table and these numbers do not coincide (replicated entries and rfc that are not part of SR)
\newcommand{\rfcStandardization}{twelve\xspace}
\newcommand{\RFCStandardization}{Twelve\xspace}
\newcommand{\numRFCStandardization}{12\xspace}

\newcommand{\draftStandardization}{fifty two\xspace}
\newcommand{\DraftStandardization}{Fifty Two\xspace}
\newcommand{\numDrafttandardization}{52\xspace}
...
\vspace{2ex}
\textbf{\\Submitted paper under review - v03 - June 2019}
\vspace{-3ex}
}
...
\input{sec/4-standardization}
\input{sec/5-tools}

\begin{comment}
\input{sec/6-deployments}
\input{sec/7-future}
\end{comment}

\input{sec/8-conclusions.tex}
